...
MAX_LEN=200 #maximum length of the input
    ...
    with open(data) as data_file:
        ...
        for i, f in enumerate(data_f):
            ...
            if i + context_window < len(data_f):
                ...
                sentenceaa = ' <eod>'
            if i<context_window:
                input = '<sod> '* (context_window-i) + ' '+sentence + ' '+sentencea + ' '+  sentenceaa
            
            else:
                sentencep = data_f[i-1]['sent']
                sentencepp = data_f[i-2]['sent']
                input = sentencepp+' '+sentencep+ ' '+sentence+ ' '+sentencea + ' '+  sentenceaa
...
if __name__=='__main__':
    ...
    train_input, train_labels = data_preprocess('train.json', WINDOW_SIZE)
    dev_input, dev_labels = data_preprocess('dev.json',WINDOW_SIZE)
